...
.movie-hero-art::after{content:"";position:absolute;inset:0;background:linear-gradient(180deg,rgba(246,201,43,.32) 0%,rgba(246,201,43,.107) 55%,rgba(10,9,8,.1) 100%)}
